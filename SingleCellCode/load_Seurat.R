...
dir10X<-function(seur=NULL,dir="",dat=NULL,lst=c(),makeSeurat=T,minGenes=500,regress=c("nFeature_RNA"),species="human",num=c(),size=1000000)
{
if(is.null(seur))
{
...
seur<-NormalizeData(seur,normalization.method="LogNormalize",scale.factor=size)
